...
def download_file_from_firebase(filename, bucket, blob_name):
    download_path = os.path.join("C:/Users/solap/Downloads", filename)  # Set download to Downloads folder
...
def main():
    ...
    try:
        ...
        if len(lines) > 2:
            ...
            show_notification(f"File downloaded: C:/Users/solap/Downloads/{filename_input}")
